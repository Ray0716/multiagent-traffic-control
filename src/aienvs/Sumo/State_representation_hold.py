...
class FactoredLDMMatrixState(LdmMatrixState):
    ...
    def update_reward(self, local_rewards=True):
        ...
        reward_extra_graph = {}
        for key in self.factored_coords.keys():
            reward_graph[key], reward_extra_graph[key] = self._ldm.getRewardByCorners(self.factored_coords[key][0], self.factored_coords[key][1], local_rewards)
        return reward_graph, reward_extra_graph, super().update_reward()
